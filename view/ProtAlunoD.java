...
public class ProtAlunoD extends JFrame implements ActionListener {
	...
	public void mostrar() {
		...
		int i = 0;
		for (Aluno d : dao.mostrarDisciplinas()) {
			dft.insertRow(i,
					new Object[] { d.getId(), d.getMatricula(), d.getNome(), d.getDisciplinas()});
			i++;
		}
	}
