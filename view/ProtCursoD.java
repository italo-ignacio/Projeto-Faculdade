...
public class ProtCursoD extends JFrame implements ActionListener {
	...
	public void mostrar() {
		...
		int i = 0;
		for (Curso d : dao.mostrarDisciplinas()) {
			dft.insertRow(i,
					new Object[] { d.getId(), d.getCodCurso(), d.getNomeCurso(), d.getDisciplinas()});
			i++;
		}
	}
